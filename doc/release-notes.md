AXSCoin Core version 2.2.1 is now available from:

  <https://github.com/axscoin-project/axscoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/axscoin-project/axscoin/issues>

Compatibility
==============

AXSCoin Core is extensively tested on multiple operating systems using
...
AXSCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that AXSCoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/axscoin-project-translations/).
