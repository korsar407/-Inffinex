...
In order to support loading of multiple wallets in axscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is axscoin.cpp.
...
Changes to axscoin.cpp
----------------------
axscoin.cpp is the entry point into axscoin-qt, and as such, will require some minor modifications to provide hooks for
