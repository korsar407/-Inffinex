Contributing to AXSCoin Core
============================

The AXSCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AXSCoin Core project, and is not to be
confused with overall AXSCoin Network Protocol consensus changes.

Whether a pull request is merged into AXSCoin Core rests with the project merge
...
Patches that change AXSCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the AXSCoin consensus, it must have been
...
The project leader is the release manager for each AXSCoin Core release.
