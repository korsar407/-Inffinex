...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "AXSCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AXSCoin features */
        {"axscoin", "masternode", &masternode, true, true, false},
        {"axscoin", "masternodelist", &masternodelist, true, true, false},
        {"axscoin", "mnbudget", &mnbudget, true, true, false},
        {"axscoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"axscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"axscoin", "mnsync", &mnsync, true, true, false},
        {"axscoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"axscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use axscoind, or the -server option to axscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"AXSCoin Alert\" admin@foo.com\n"),
...
{
    return "> axscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13779/\n";
}
