/* src/config/axscoin-config.h.  Generated from axscoin-config.h.in by configure.  */
/* src/config/axscoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.axs.gold"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AXSCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AXSCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "axscoin"
