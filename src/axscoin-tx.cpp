...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AXSCoin Core axscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  axscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded axscoin transaction") + "\n" +
                               "  axscoin-tx [options] -create [commands]   " + _("Create hex-encoded axscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded axscoin transaction
