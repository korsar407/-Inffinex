...
This means one can have an always-on axscoind instance running, and another local axscoind/axscoin-qt instance which connects to this node and receives blocks from it.
