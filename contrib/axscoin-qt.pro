...
RESOURCES += src/qt/axscoin.qrc src/qt/axscoin_locale.qrc

TRANSLATIONS += src/qt/locale/axscoin_bg.ts \
                src/qt/locale/axscoin_de.ts \
                src/qt/locale/axscoin_en.ts \
                src/qt/locale/axscoin_es.ts \
                src/qt/locale/axscoin_fi.ts \
                src/qt/locale/axscoin_fr.ts \
                src/qt/locale/axscoin_it.ts \
                src/qt/locale/axscoin_ja.ts \
                src/qt/locale/axscoin_pl.ts \
                src/qt/locale/axscoin_pt.ts \
                src/qt/locale/axscoin_ru.ts \
                src/qt/locale/axscoin_sk.ts \
                src/qt/locale/axscoin_sv.ts \
                src/qt/locale/axscoin_vi.ts \
                src/qt/locale/axscoin_zh_CN.ts \
                src/qt/locale/axscoin_zh_TW.ts
